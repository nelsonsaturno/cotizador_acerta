...
class CotizacionUpdateForm(forms.Form):
    ...
    cuotas3 = forms.IntegerField(min_value=2, max_value=10, label="Cuotas", required=False, initial=2)
    tipo_pago = forms.ChoiceField(choices=[(0, 'Pago de Contado'), (1, 'Pago Prima ACH'), (2, 'Pago TCR'), (3, 'Otro')],
