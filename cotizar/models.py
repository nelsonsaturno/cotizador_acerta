...
class Conductor(models.Model):
    ...
    telefono2 = models.CharField(max_length=20, blank=False)
...
class Vehiculo(models.Model):
    ...
    conductor = models.ForeignKey(Conductor, blank=False)
    ...
    antiguedad = models.CharField(max_length=30, blank=False, default='Menor',
                                  choices=[('Menor', 'Menor o igual a 3 años'),
                                           ('Mayor', 'Mayor a 3 años')])
    uso = models.PositiveSmallIntegerField(blank=False)
...
class Cotizacion(models.Model):
    ...
    conductor = models.ForeignKey(Conductor, blank=False)
    vehiculo = models.ForeignKey(Vehiculo, blank=False)
