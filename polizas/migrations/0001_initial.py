    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cobrador', models.CharField(max_length=20)),
                ('dir_cobro', models.CharField(max_length=100)),
                ('tipo_tdc', models.CharField(default=b'Visa', max_length=30, choices=[(b'Visa', b'Visa'), (b'Mastercard', b'Mastercad'), (b'Dinners', b'Dinners'), (b'American Express', b'American Express')])),
                ('num_tdc', models.CharField(max_length=16)),
                ('banco_tdc', models.CharField(max_length=20)),
