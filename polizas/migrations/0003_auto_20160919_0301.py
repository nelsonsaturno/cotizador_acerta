...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('polizas', '0002_auto_20160919_0247'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conductor', models.ForeignKey(to='cotizar.ConductorVehiculo', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Referencia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_tdc', models.CharField(default=b'Visa', max_length=30, null=True, choices=[(b'Visa', b'Visa'), (b'Mastercard', b'Mastercad'), (b'Dinners', b'Dinners'), (b'American Express', b'American Express')])),
                ('num_tdc', models.CharField(max_length=16, null=True)),
